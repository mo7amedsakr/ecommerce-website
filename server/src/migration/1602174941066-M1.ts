...
export class M11602174941066 implements MigrationInterface {
  name = 'M11602174941066';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "order" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "total" numeric(10,2) NOT NULL, "inserted_at" TIMESTAMP NOT NULL DEFAULT NOW(), CONSTRAINT "PK_1031171c13130102495201e3e20" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
